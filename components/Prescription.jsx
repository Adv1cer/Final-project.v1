...
export default function Prescriptions() {
    ...
    return (
        <div>
            ...
            <ToastContainer />
            <div className="">
                <div className=" bg-gray-100 grid col-3 gap-2 ">
                    <div className="my-10">
                        <div className="grid col-start-2 ">
                            <div className="bg-white shadow-md display-border py-4 p-8 max-w-lg w-1/4 m-auto">
                                <h1 className="flex justify-center content-center text-xl my-2">ประวัติผู้ป่วย</h1>
                                <div className="mx-4">
                                <p>เวลาเช็คอิน</p>
                                <p className="ml-6">{new Date(ticket.datetime).toLocaleString()}</p>
                                <p>ชื่อผู้ป่วย</p>
                                <p className="ml-6">{ticket.patient_name}</p>
                                <h2>อาการ</h2>
                                {ticket.symptoms.length > 0 ? (
                                    ...
                                    <p>ไม่ได้ระบุอาการอาการ.</p>
                                )}
                                {ticket.other_symptom && (
                                    <div className="my-2">
                                        <h2>หมายเหตุ</h2>
                                        <ul className="ml-6">
                                            <li>{ticket.other_symptom}</li>
                                        </ul>
                                    </div>
                                )}
                                </div>
