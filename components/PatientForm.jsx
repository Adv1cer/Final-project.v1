    ...
    const onSubmit = async (event) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const selectedSymptomLabels = sortedSymptoms.map(id => symptomLabels[id] || "Unknown").join(", ");

                toast({
                    variant: "success",
                    title: 'Data Submitted',
                    description: `รหัสนักศึกษา ${studentId} ชื่อ-นามสกุล ${studentName} อาการ ${selectedSymptomLabels} ${isOtherChecked ? ` ${otherSymptom}` : ''}`,
                    duration: 2000,
                });
    ...
    return (
        ...
        <div>
            <div className="flex justify-center items-center min-h-screen bg-custom">
                <div className="bg-zinc-100 shadow-md rounded-lg p-8 max-w-lg w-full mb-20">
